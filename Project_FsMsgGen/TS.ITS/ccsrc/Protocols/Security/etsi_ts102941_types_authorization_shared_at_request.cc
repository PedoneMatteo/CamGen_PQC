...
int etsi_ts102941_types_authorization_shared_at_request::encode(const EtsiTs102941TypesAuthorization::SharedAtRequest &p_shared_at_request,
                                                                OCTETSTRING &                                          p_data) {
...
int etsi_ts102941_types_authorization_shared_at_request::decode(const OCTETSTRING &p_data, EtsiTs102941TypesAuthorization::SharedAtRequest &p_shared_at_request,
                                                                params *p_params) {
