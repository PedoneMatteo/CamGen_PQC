...
int etsi_ts103097_tobesigned_data_codec::encode(const Ieee1609Dot2::ToBeSignedData &p_cert, OCTETSTRING &data) {
  loggers::get_instance().log(">>> etsi_ts103097_tobesigned_data_codec::encode: %s", p_cert.get_descriptor()->name);
  ...
  loggers::get_instance().log_msg("etsi_ts103097_tobesigned_data_codec::encode: ", data);

  return 0;
}

int etsi_ts103097_tobesigned_data_codec::decode(const OCTETSTRING &data, Ieee1609Dot2::ToBeSignedData &p_cert, params *params) {
  loggers::get_instance().log_msg(">>> etsi_ts103097_tobesigned_data_codec::decode: ", data);
  ...
  loggers::get_instance().log_msg("<<< etsi_ts103097_tobesigned_data_codec::decode: ", (const Base_Type &)p_cert);
  return 0;
}
