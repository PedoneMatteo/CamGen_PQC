...
class ConfigRsuSimulatorLayerFactory : public layer_factory {
...
public:
  ...
  inline virtual layer *create_layer(const std::string &p_type, const std::string &p_param) { return new ConfigRsuSimulatorLayer(p_type, p_param); };
