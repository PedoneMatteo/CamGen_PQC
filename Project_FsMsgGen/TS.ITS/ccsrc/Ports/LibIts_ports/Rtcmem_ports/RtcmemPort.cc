...
namespace LibItsRtcmem__TestSystem {
  ...
  RtcmemPort::RtcmemPort(const char *par_port_name)
    : RtcmemPort_BASE(par_port_name), _cfg_params(), _layer_params(), _layer(NULL), _time_key("RtcmemPort::outgoing_send") {}
  ...
  void RtcmemPort::receiveMsg(const LibItsRtcmem__TypesAndValues::RtcmemInd &p_ind, const params &p_params) {
